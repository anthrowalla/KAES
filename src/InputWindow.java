...
public class InputWindow extends Frame
{
	public InputWindow()
	{
		...
		setVisible(false);
		setSize(ScaleManager.s(325),ScaleManager.s(216));
		setFont(ScaleManager.font("Serif", Font.PLAIN, 12));
		panel1 = new java.awt.Panel();
		panel1.setLayout(new BorderLayout(0,0));
		panel1.setBounds(ScaleManager.s(0),ScaleManager.s(0),ScaleManager.s(325),ScaleManager.s(0));
		add("North", panel1);
		question = new java.awt.TextArea("",0,0,TextArea.SCROLLBARS_NONE);
		question.setBounds(ScaleManager.s(0),ScaleManager.s(0),ScaleManager.s(294),ScaleManager.s(142));
		panel1.add("North", question);
		controlPanel = new java.awt.Panel();
		controlPanel.setLayout(new BorderLayout(0,0));
		controlPanel.setBounds(0,ScaleManager.s(216),ScaleManager.s(325),0);
