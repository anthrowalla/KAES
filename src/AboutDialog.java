...
public class AboutDialog extends Dialog {
	...
	public AboutDialog(Frame parent, boolean modal)
	{
		...
		//{{INIT_CONTROLS
		setLayout(null);
		setSize(ScaleManager.s(249),ScaleManager.s(150));
		setVisible(false);
		label1.setText("Kaes v 3.03 Copyright 1984-2005");
		add(label1);
		label1.setBounds(ScaleManager.s(40),ScaleManager.s(35),ScaleManager.s(166),ScaleManager.s(21));
		okButton.setLabel("OK");
		add(okButton);
		okButton.setBounds(ScaleManager.s(95),ScaleManager.s(85),ScaleManager.s(66),ScaleManager.s(27));
