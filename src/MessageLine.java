...
//	static HelpMessageFrame theHelper = new HelpMessageFrame();
	...
	public MessageLine()
	{
		...
		//{{INIT_CONTROLS
		setLayout(null);
		setSize(ScaleManager.s(605),ScaleManager.s(24));
		priorityLabel.setText("Hi");
		priorityLabel.setAlignment(java.awt.Label.RIGHT);
		add(priorityLabel);
		priorityLabel.setFont(ScaleManager.font("Serif", Font.BOLD, 10));
		priorityLabel.setBounds(ScaleManager.s(5),ScaleManager.s(2),ScaleManager.s(37),ScaleManager.s(16));
		oneLineAlertLabel.setText("text");
		add(oneLineAlertLabel);
		oneLineAlertLabel.setFont(ScaleManager.font("Serif", Font.BOLD, 12));
		oneLineAlertLabel.setBounds(ScaleManager.s(50),ScaleManager.s(2),ScaleManager.s(448),ScaleManager.s(18));
		actionButton.setLabel("Details");
		add(actionButton);
		actionButton.setFont(ScaleManager.font("SansSerif", Font.BOLD, 10));
		actionButton.setBounds(ScaleManager.s(510),ScaleManager.s(4),ScaleManager.s(61),ScaleManager.s(15));
		add(iconCanvas);
		iconCanvas.setBounds(ScaleManager.s(573),ScaleManager.s(0),ScaleManager.s(22),ScaleManager.s(22));
		//}}
