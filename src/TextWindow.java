...
public class TextWindow extends ProtoFrame
{
	public TextWindow(String title, String description, String content)
	{
		...
		setVisible(false);
		setSize(ScaleManager.s(544),ScaleManager.s(557));
		titleLabel = new java.awt.Label("Title",Label.CENTER);
		titleLabel.setBounds(ScaleManager.s(0),ScaleManager.s(0),ScaleManager.s(544),ScaleManager.s(33));
		titleLabel.setFont(ScaleManager.font("Dialog", Font.PLAIN, 18));
		...
		contentText.setBounds(ScaleManager.s(0),ScaleManager.s(33),ScaleManager.s(544),ScaleManager.s(524));
		contentText.setFont(ScaleManager.font("Serif", Font.PLAIN, 14));
		gbc = new GridBagConstraints();
		gbc.gridx = 0;
		gbc.gridy = 1;
		gbc.weightx = 0.5;
