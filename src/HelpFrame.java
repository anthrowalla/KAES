...
public class HelpFrame extends Frame
{
	public HelpFrame()
	{
		...
		setVisible(false);
		setSize(ScaleManager.s(781),ScaleManager.s(600));
		setCursor(new Cursor(Cursor.HAND_CURSOR));
		panel1 = new java.awt.Panel();
		panel1.setLayout(null);
		panel1.setBounds(ScaleManager.s(0),ScaleManager.s(0),ScaleManager.s(781),ScaleManager.s(59));
		add("North", panel1);
		...
		try {
			...
			browser1.setBounds(ScaleManager.s(0),ScaleManager.s(59),ScaleManager.s(781),ScaleManager.s(541));
			add("Center", browser1);
