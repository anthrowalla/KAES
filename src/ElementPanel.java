...
public class ElementPanel extends Panel
{
	...
	public ElementPanel()
	{
		...
		//{{INIT_CONTROLS
		setLayout(null);
		setSize(ScaleManager.s(283),ScaleManager.s(155));
		spouseButton.setCheckboxGroup(Group1);
		spouseButton.setLabel("Spouse");
		add(spouseButton);
		spouseButton.setBounds(ScaleManager.s(183),ScaleManager.s(117),ScaleManager.s(99),ScaleManager.s(28));
		generatorButton.setCheckboxGroup(Group1);
		generatorButton.setState(true);
		generatorButton.setLabel("Generator");
		add(generatorButton);
		generatorButton.setBounds(ScaleManager.s(183),ScaleManager.s(86),ScaleManager.s(99),ScaleManager.s(28));
		identityButton.setCheckboxGroup(Group1);
		identityButton.setLabel("Identity");
		add(identityButton);
		identityButton.setBounds(ScaleManager.s(183),ScaleManager.s(55),ScaleManager.s(99),ScaleManager.s(28));
		itemLabel.setText("Generator");
		add(itemLabel);
		itemLabel.setBounds(ScaleManager.s(8),ScaleManager.s(57),ScaleManager.s(74),ScaleManager.s(31));
		add(itemField);
		itemField.setFont(ScaleManager.font("Serif", Font.PLAIN, 14));
		itemField.setBounds(ScaleManager.s(88),ScaleManager.s(55),ScaleManager.s(43),ScaleManager.s(35));
		messageArea.setEditable(false);
		add(messageArea);
		messageArea.setBounds(ScaleManager.s(7),ScaleManager.s(4),ScaleManager.s(272),ScaleManager.s(49));
		cancelButton.setLabel("Cancel");
		add(cancelButton);
		cancelButton.setBounds(ScaleManager.s(5),ScaleManager.s(125),ScaleManager.s(60),ScaleManager.s(23));
		addButton.setLabel("Add Generator");
		add(addButton);
		addButton.setBounds(ScaleManager.s(32),ScaleManager.s(92),ScaleManager.s(99),ScaleManager.s(24));
		helpButton.setLabel("Help");
		add(helpButton);
		helpButton.setBounds(ScaleManager.s(110),ScaleManager.s(126),ScaleManager.s(60),ScaleManager.s(23));
		//}}
...
*/
    ...
    public void paint(Graphics g) {
		...
		g.drawRect(ScaleManager.s(2),ScaleManager.s(2),r.width-ScaleManager.s(4), r.height-ScaleManager.s(4));
