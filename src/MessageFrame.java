...
public class MessageFrame extends Frame implements MessageAction
{
	public MessageFrame()
	{
		...
		setVisible(false);
		setSize(ScaleManager.s(745),ScaleManager.s(636));
		messagePanel1 = new MessagePanel();
		messagePanel1.setLayout(null);
		messagePanel1.setBounds(ScaleManager.s(0),ScaleManager.s(0),ScaleManager.s(666),ScaleManager.s(628));
		messagePanel1.setFont(ScaleManager.font("SansSerif", Font.PLAIN, 12));
