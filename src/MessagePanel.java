...
public class MessagePanel extends java.awt.Panel
{
	...
	public MessagePanel()
	{
		...
		setSize(ScaleManager.s(673),ScaleManager.s(625));
		setFont(ScaleManager.font("SansSerif", Font.PLAIN, 12));
		messagescrollPanel = new java.awt.Panel();
		gridBagLayout = new GridBagLayout();
		messagescrollPanel.setLayout(gridBagLayout);
		messagescrollPanel.setBounds(ScaleManager.s(0),ScaleManager.s(0),ScaleManager.s(673),ScaleManager.s(189));
		...
		verticalScrollbar1.setBounds(ScaleManager.s(657),ScaleManager.s(0),ScaleManager.s(16),ScaleManager.s(189));
		gbc = new GridBagConstraints();
		gbc.gridx = 5;
		gbc.gridy = 0;
		...
		scrollPanel.setBounds(ScaleManager.s(5),ScaleManager.s(5),ScaleManager.s(647),ScaleManager.s(179));
		gbc = new GridBagConstraints();
		gbc.gridx = 0;
		gbc.gridy = 0;
		gbc.gridwidth = 4;
		...
		detailText.setBounds(ScaleManager.s(0),ScaleManager.s(189),ScaleManager.s(673),ScaleManager.s(182));
		gbc = new GridBagConstraints();
		gbc.gridx = 0;
		gbc.gridy = 4;
		gbc.weightx = 0.5;
		...
		infoPanel.setBounds(ScaleManager.s(5),ScaleManager.s(376),ScaleManager.s(663),ScaleManager.s(245));
		gbc = new GridBagConstraints();
		gbc.gridx = 0;
		gbc.gridy = 5;
		gbc.gridwidth = 8;
