...
public class EquationPanel extends Panel
{
	...
	public EquationPanel()
	{
		...
		//{{INIT_CONTROLS
		setLayout(null);
		setSize(ScaleManager.s(495),ScaleManager.s(327));
		add(currentEquations);
		currentEquations.setBounds(ScaleManager.s(310),ScaleManager.s(112),ScaleManager.s(173),ScaleManager.s(161));
		label7.setText("Elements");
		add(label7);
		label7.setFont(ScaleManager.font("Serif", Font.BOLD, 12));
		label7.setBounds(ScaleManager.s(4),ScaleManager.s(86),ScaleManager.s(60),ScaleManager.s(17));
		label3.setText("Elements");
		add(label3);
		label3.setFont(ScaleManager.font("Serif", Font.BOLD, 12));
		label3.setBounds(ScaleManager.s(4),ScaleManager.s(49),ScaleManager.s(60),ScaleManager.s(17));
		currentElementsField.setEditable(false);
		add(currentElementsField);
		currentElementsField.setBounds(ScaleManager.s(73),ScaleManager.s(37),ScaleManager.s(181),ScaleManager.s(26));
		explanation.setEditable(false);
		add(explanation);
		explanation.setBounds(ScaleManager.s(309),ScaleManager.s(9),ScaleManager.s(174),ScaleManager.s(90));
		spouseButton.setCheckboxGroup(Group1);
		spouseButton.setLabel("Spouse");
		add(spouseButton);
		spouseButton.setBounds(ScaleManager.s(184),ScaleManager.s(185),ScaleManager.s(99),ScaleManager.s(28));
		generatorButton.setCheckboxGroup(Group1);
		generatorButton.setState(true);
		generatorButton.setLabel("Generator");
		add(generatorButton);
		generatorButton.setBounds(ScaleManager.s(86),ScaleManager.s(185),ScaleManager.s(99),ScaleManager.s(28));
		identityButton.setCheckboxGroup(Group1);
		identityButton.setLabel("Identity");
		add(identityButton);
		identityButton.setBounds(ScaleManager.s(4),ScaleManager.s(185),ScaleManager.s(99),ScaleManager.s(28));
		itemLabel.setText("New Generator");
		itemLabel.setAlignment(java.awt.Label.RIGHT);
		add(itemLabel);
		itemLabel.setForeground(java.awt.Color.red);
		itemLabel.setFont(ScaleManager.font("Serif", Font.BOLD, 12));
		itemLabel.setBounds(ScaleManager.s(4),ScaleManager.s(161),ScaleManager.s(94),ScaleManager.s(24));
		add(itemField);
		itemField.setFont(ScaleManager.font("Serif", Font.PLAIN, 14));
		itemField.setBounds(ScaleManager.s(105),ScaleManager.s(160),ScaleManager.s(38),ScaleManager.s(25));
		equationArea.setEditable(false);
		add(equationArea);
		equationArea.setBounds(ScaleManager.s(73),ScaleManager.s(115),ScaleManager.s(223),ScaleManager.s(26));
		cancelButton.setLabel("Cancel");
		add(cancelButton);
		cancelButton.setBounds(ScaleManager.s(326),ScaleManager.s(290),ScaleManager.s(60),ScaleManager.s(23));
		add(okButton);
		okButton.setBackground(java.awt.Color.white);
		okButton.setForeground(java.awt.Color.black);
		okButton.setBounds(ScaleManager.s(151),ScaleManager.s(146),ScaleManager.s(150),ScaleManager.s(32));
		helpButton.setLabel("Help");
		add(helpButton);
		helpButton.setBounds(ScaleManager.s(420),ScaleManager.s(287),ScaleManager.s(60),ScaleManager.s(23));
		label2.setText("Enter Equations");
		add(label2);
		label2.setForeground(java.awt.Color.blue);
		label2.setFont(ScaleManager.font("Dialog", Font.PLAIN, 12));
		label2.setBounds(ScaleManager.s(4),ScaleManager.s(2),ScaleManager.s(123),ScaleManager.s(22));
		label4.setText("Equation");
		add(label4);
		label4.setForeground(java.awt.Color.blue);
		label4.setFont(ScaleManager.font("Serif", Font.BOLD, 12));
		label4.setBounds(ScaleManager.s(4),ScaleManager.s(128),ScaleManager.s(60),ScaleManager.s(17));
		label5.setText("Available");
		add(label5);
		label5.setFont(ScaleManager.font("Serif", Font.BOLD, 12));
		label5.setBounds(ScaleManager.s(4),ScaleManager.s(72),ScaleManager.s(60),ScaleManager.s(17));
		label6.setText("New");
		add(label6);
		label6.setForeground(java.awt.Color.blue);
		label6.setFont(ScaleManager.font("Serif", Font.BOLD, 12));
		label6.setBounds(ScaleManager.s(4),ScaleManager.s(117),ScaleManager.s(60),ScaleManager.s(17));
		availableElementsField.setEditable(false);
		add(availableElementsField);
		availableElementsField.setBounds(ScaleManager.s(73),ScaleManager.s(72),ScaleManager.s(158),ScaleManager.s(26));
		label8.setText("Current");
		add(label8);
		label8.setFont(ScaleManager.font("Serif", Font.BOLD, 12));
		label8.setBounds(ScaleManager.s(4),ScaleManager.s(35),ScaleManager.s(60),ScaleManager.s(17));
		//}}
