...
public class KinshipTermsPanel extends Panel implements KinTermEditor
{
	...
	public KinshipTermsPanel()
	{
		...
		//{{INIT_CONTROLS
		setLayout(null);
		setSize(ScaleManager.s(864),ScaleManager.s(607));
		touchypanel = new java.awt.Panel();
		touchypanel.setLayout(null);
		touchypanel.setVisible(false);
		touchypanel.setBounds(ScaleManager.s(9),ScaleManager.s(524),ScaleManager.s(249),ScaleManager.s(62));
		add(touchypanel);
		...
		etcCheckbox.setFont(ScaleManager.font("SansSerif", Font.PLAIN, 10));
		...
		generatorCheckbox.setFont(ScaleManager.font("SansSerif", Font.PLAIN, 10));
	...
	*/
	...
	public void buildKintermEntries(TransferKinInfoVector kinfo) {
		...
		for (int i=0;i<kinfo.size();i++) {
			...
			kt.setBounds(ScaleManager.s(10),ScaleManager.s(10),ScaleManager.s(100),ScaleManager.s(20));
			kt.setSex(k.getSex());
		...
		for (int i=0;i<c.length;i++) {
			if (c[i] instanceof KintermEntryForm) { // patch up if changed!!!!!!!!!!!!!!!!!!!!!
				if (!gendone) {
					...
					gendone = true;
					xx.setLocation(ScaleManager.s(15),loc); loc+=ScaleManager.s(20);
					Label q = new Label("Terms");
					q.setSize(ScaleManager.s(30),ScaleManager.s(20));
					//q.setForeground(Color.black);
					//q.setBackground(Color.yellow);
					p.add(q);
					//q.setVisible(true);
					q.setLocation(ScaleManager.s(15),loc);loc += ScaleManager.s(25);
				}
				...
				swi = !swi;
				xx.setLocation(ScaleManager.s(15),loc);loc += ScaleManager.s(16);
			}
		}
		
		p.newKintableTermButton = new Button("New Term");
		p.newKintableTermButton.addActionListener(p.lSymAction);
		p.newKintableTermButton.setSize(ScaleManager.s(90),ScaleManager.s(25));
		p.add(p.newKintableTermButton);
		p.newKintableTermButton.setLocation(ScaleManager.s(15),loc+ScaleManager.s(20));
		QSort qs = new QSort();
		int [] ndx=null;
		try {
